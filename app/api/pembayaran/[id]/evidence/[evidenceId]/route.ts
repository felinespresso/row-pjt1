...
export async function GET(
  ...
  try {
    const evidence = await prisma.evidencePembayaran.findUnique({
      where: {
...
export async function DELETE(
  ...
  try {
    const deletedEvidence = await prisma.evidencePembayaran.delete({
      where: {
        id: params.evidenceId,
        pembayaranId: params.id,
      },
...
export async function PUT(
  ...
  try {
    ...
    const existingEvidence = await prisma.evidencePembayaran.findUnique({
      where: {
        id: params.evidenceId,
        pembayaranId: params.id,
      },
    ...
    const updatedEvidence = await prisma.evidencePembayaran.update({
      where: {
        id: params.evidenceId,
        pembayaranId: params.id,
      },
