...
export async function GET(
  ...
  try {
    const evidence = await prisma.evidencePenebangan.findUnique({
      where: {
...
export async function DELETE(
  ...
  try {
    const deletedEvidence = await prisma.evidencePenebangan.delete({
      where: {
        id: params.evidenceId,
        penebanganId: params.id,
      },
...
export async function PUT(
  ...
  try {
    ...
    const existingEvidence = await prisma.evidencePenebangan.findUnique({
      where: {
        id: params.evidenceId,
        penebanganId: params.id,
      },
    ...
    const updatedEvidence = await prisma.evidencePenebangan.update({
      where: {
        id: params.evidenceId,
        penebanganId: params.id,
      },
