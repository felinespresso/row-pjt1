...
interface ExportButtonProps {
  pembayaranData: PembayaranItem[];
}

const ExportButtonPembayaran: FC<ExportButtonProps> = ({ pembayaranData }) => {
  const exportToExcel = async () => {
    ...
    pembayaranData.forEach((item, index) => {
      worksheet.addRow({
        no: index + 1,
    ...
    saveAs(new Blob([buffer]), "Tabel Data Pembayaran.xlsx");
  };
...
export default ExportButtonPembayaran;
