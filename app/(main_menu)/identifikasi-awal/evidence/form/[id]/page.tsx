                        ...
                        <div>
                            <div className="h-full pb-2 bg-color9">
                                ...
                                <div className="flex justify-between w-full mt-[-6px]">
                                    ...
                                    <div aria-live="polite" aria-atomic="true" id="file-error" className="w-10/12 text-red-500 text-[12px]">
                            ...
                            <div className="h-full pb-2 bg-white">
                                ...
                                <div className="flex justify-between w-full mt-[-7px]">
                                    <div className="w-4/12"></div>
                                    <div aria-live="polite" aria-atomic="true" id="namaPemilik-error" className="w-10/12 text-red-500 text-[12px]">
                            ...
                            <div className="h-full pb-2 bg-color9">
                                ...
                                <div className="flex justify-between w-full mt-[-7px]">
                                    <div className="w-4/12"></div>
                                    <div aria-live="polite" aria-atomic="true" id="spantower-error" className="w-10/12 text-red-500 text-[12px]">
