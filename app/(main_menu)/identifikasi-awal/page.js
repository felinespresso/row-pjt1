...
import { Delete, EditButton, EvidenceButton } from "@/app/_components/buttons";
import { MdAddCircleOutline } from "react-icons/md";
import { FaRegTrashAlt, FaFileAlt } from "react-icons/fa";
import { getData } from "@/lib/identifikasi/data";
import Link from "next/link";
import { Pagination } from "@/app/_components/button";
import AnimatedContainer from "@/app/_components/motion/AnimatedContainer";
import Loading from "./loading";

const TableContent = React.lazy(async () => {
...
export default function IdentifikasiAwal() {
  // const session = await auth();
  // const [identifikasiData, setIdentifikasiData] = useState([]);
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex space-x-4">
                ...
                <Link href="/identifikasi-awal/form">
